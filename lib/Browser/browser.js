...
const Browser = function Browser(username, apiKey, baseUri) {
    ...
    return new Promise(((resolve, reject) => {
      ...
      request.post(this.lastRequest, (error, response, body) => {
        if (error) {
          ...
          token = that.setAccessToken(body.tokenType, body.accessToken,
              body.refreshToken);
          resolve(token);
        }
      });
  ...
  this.setAccessToken = function setAccessToken(
